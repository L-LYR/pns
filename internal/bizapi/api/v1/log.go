...
type TaskLogReq struct {
	...
	TaskId int64 `json:"taskId"  dc:"push task id, returned by successful /push response" v:"required#task id is required"`
}
...
type PushLogReq struct {
	...
	TaskId   int64  `json:"taskId" dc:"push task id" v:"required#push task id is required"`
